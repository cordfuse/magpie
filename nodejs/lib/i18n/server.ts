// Server-only locale resolver. Reads the magpie_locale cookie via Next's
// headers() API and falls back to the server default (MAGPIE_LOCALE env, or
...
export async function resolveLocale(
  ...
  try {
    ...
    const cookieVal = c.get('magpie_locale')?.value
